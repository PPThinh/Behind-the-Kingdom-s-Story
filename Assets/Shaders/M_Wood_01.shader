Shader "Unreal/M_Wood_01"
{
    Properties
    {
		...
		Material_Texture2D_0( "Wood_FloorBoards_01_Normals", 2D ) = "white" {}
		Material_Texture2D_1( "Wood_FloorBoards_01_Diffuse", 2D ) = "white" {}
