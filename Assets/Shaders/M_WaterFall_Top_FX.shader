Shader "Unreal/M_WaterFall_Top_FX"
{
    Properties
    {
		...
		Material_Texture2D_0( "FX_Waterfall_Top_01", 2D ) = "white" {}
		Material_Texture2D_1( "Gradient_Center_02", 2D ) = "white" {}
		Material_Texture2D_2( "Gradient_Center_04", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_WaterFall_Top_FX.hlsl"
