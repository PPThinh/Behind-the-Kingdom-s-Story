Shader "Unreal/M_Marble_White_03"
{
    Properties
    {
		...
		Material_Texture2D_0( "Stucco_Normals_03", 2D ) = "white" {}
		Material_Texture2D_1( "Marble_White_03", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Marble_White_03.hlsl"
