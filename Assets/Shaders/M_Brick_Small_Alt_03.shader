Shader "Unreal/M_Brick_Small_Alt_03"
{
    Properties
    {
		...
		Material_Texture2D_0( "Brick_Small_Normals_03", 2D ) = "white" {}
		Material_Texture2D_1( "Brick_Small_Alt_03", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Brick_Small_Alt_03.hlsl"
