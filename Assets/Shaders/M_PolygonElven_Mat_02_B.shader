Shader "Unreal/M_PolygonElven_Mat_02_B"
{
    Properties
    {
		...
		Material_Texture2D_0( "PolygonElven_Emissive_02_B", 2D ) = "white" {}
		Material_Texture2D_1( "PolygonElven_Texture_02_B", 2D ) = "white" {}
		Material_Texture2D_2( "PolygonElven_Metallic_2B", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_PolygonElven_Mat_02_B.hlsl"
