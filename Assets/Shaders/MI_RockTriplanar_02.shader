Shader "Unreal/MI_RockTriplanar_02"
{
    Properties
    {
		...
		Material_Texture2D_0( "RockWall_Normals_02", 2D ) = "white" {}
		Material_Texture2D_1( "Top_rock_color", 2D ) = "white" {}
		Material_Texture2D_2( "RockWall_Texture_01", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_RockTriplanar_02.hlsl"
