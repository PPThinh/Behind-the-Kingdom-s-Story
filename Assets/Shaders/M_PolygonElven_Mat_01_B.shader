Shader "Unreal/M_PolygonElven_Mat_01_B"
{
    Properties
    {
		...
		Material_Texture2D_0( "PolygonElven_Emissive_01_B", 2D ) = "white" {}
		Material_Texture2D_1( "PolygonElven_Texture_01_B", 2D ) = "white" {}
		Material_Texture2D_2( "PolygonElven_Metallic_1B", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_PolygonElven_Mat_01_B.hlsl"
