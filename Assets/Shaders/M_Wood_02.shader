Shader "Unreal/M_Wood_02"
{
    Properties
    {
		...
		Material_Texture2D_0( "Wood_FloorBoards_02_Normals", 2D ) = "white" {}
		Material_Texture2D_1( "Wood_FloorBoards_02_Diffuse", 2D ) = "white" {}
