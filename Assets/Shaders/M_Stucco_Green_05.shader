Shader "Unreal/M_Stucco_Green_05"
{
    Properties
    {
		...
		Material_Texture2D_0( "Stucco_Normals_05", 2D ) = "white" {}
		Material_Texture2D_1( "Stucco_Green_05", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Stucco_Green_05.hlsl"
