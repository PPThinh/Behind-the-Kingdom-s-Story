Shader "Unreal/M_Marble_Black_04"
{
    Properties
    {
		...
		Material_Texture2D_0( "Stucco_Normals_04", 2D ) = "white" {}
		Material_Texture2D_1( "Marble_Black_04", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Marble_Black_04.hlsl"
