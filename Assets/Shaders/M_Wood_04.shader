Shader "Unreal/M_Wood_04"
{
    Properties
    {
		...
		Material_Texture2D_0( "Wood_DockBoards_01_Normals", 2D ) = "white" {}
		Material_Texture2D_1( "Wood_DockBoards_01_Diffuse", 2D ) = "white" {}
