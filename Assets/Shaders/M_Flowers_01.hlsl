...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,1.000000,0.738965,1.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,1.000000,0.738965,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[4] = float4(600943099904.000000,0.000000,88885619501039616.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[5] = float4(598950805504.000000,0.000000,88885619501039616.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local4 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 2);
	...
	MaterialFloat Local6 = MaterialStoreTexSample(Parameters, Local5, 2);
	MaterialFloat3 Local7 = (Material.PreshaderBuffer[2].xyz * Local5.rgb);
	MaterialFloat3 Local8 = (Local7 * ((MaterialFloat3)Material.PreshaderBuffer[2].w));
	MaterialFloat3 Local9 = lerp(Local8,Material.PreshaderBuffer[3].yzw,Material.PreshaderBuffer[3].x);
	MaterialFloat Local10 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 0);
	MaterialFloat4 Local11 = UnpackNormalMap(Texture2DSampleBias(Material_Texture2D_2,sampler_Material_Texture2D_2,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local12 = MaterialStoreTexSample(Parameters, Local11, 0);
	MaterialFloat Local13 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local0), 3);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3,sampler_Material_Texture2D_3,DERIV_BASE_VALUE(Local0),View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 3);

	PixelMaterialInputs.EmissiveColor = Local9;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local14.a;
	PixelMaterialInputs.BaseColor = Local11.rgb;
