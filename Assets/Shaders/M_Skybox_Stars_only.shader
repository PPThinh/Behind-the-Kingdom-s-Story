Shader "Unreal/M_Skybox_Stars_only"
{
    Properties
    {
		...
		Material_TextureCube_0( "Skybox_Stars_only", Cube ) = "white" {}
    ...
    SubShader
    {
        //BLEND_OFF Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Opaque" "UniversalMaterialType" = "Unlit" "Queue"="Geometry" }
        ...
        #include "M_Skybox_Stars_only.hlsl"
