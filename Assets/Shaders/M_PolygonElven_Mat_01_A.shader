Shader "Unreal/M_PolygonElven_Mat_01_A"
{
    Properties
    {
		...
		Material_Texture2D_0( "PolygonElven_Emissive_01_A", 2D ) = "white" {}
		Material_Texture2D_1( "PolygonElven_Texture_01_A", 2D ) = "white" {}
		Material_Texture2D_2( "PolygonElven_Metallic_1A", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_PolygonElven_Mat_01_A.hlsl"
