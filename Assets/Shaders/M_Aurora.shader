Shader "Unreal/M_Aurora"
{
    Properties
    {
		...
		Material_Texture2D_0( "Gradient_Up_01", 2D ) = "white" {}
		Material_Texture2D_1( "Gradient_Down_01", 2D ) = "white" {}
		Material_Texture2D_2( "FX_Aurora", 2D ) = "white" {}
		Material_Texture2D_3( "Gradient_Center_02", 2D ) = "white" {}
