...
SAMPLER( sampler_Material_TextureCube_0 );
...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[3] = float4(600104239104.000000,0.000000,260380672.000000,0.000000);//(Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = ReflectionAboutCustomWorldNormal(Parameters, MaterialFloat3(0.00000000,0.00000000,0.00000000), false);
	MaterialFloat Local1 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local2 = ProcessMaterialColorTextureLookup(TextureCubeSample(Material_TextureCube_0,sampler_Material_TextureCube_0,Local0));
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(((MaterialFloat2)MaterialFloat2(1.00000000,0.00000000).x).x,Material.PreshaderBuffer[2].x);
