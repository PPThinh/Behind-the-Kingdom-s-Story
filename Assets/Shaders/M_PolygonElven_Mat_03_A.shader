Shader "Unreal/M_PolygonElven_Mat_03_A"
{
    Properties
    {
		...
		Material_Texture2D_0( "PolygonElven_Emissive_03_A", 2D ) = "white" {}
		Material_Texture2D_1( "PolygonElven_Texture_03_A", 2D ) = "white" {}
		Material_Texture2D_2( "PolygonElven_Metallic_3A", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_PolygonElven_Mat_03_A.hlsl"
