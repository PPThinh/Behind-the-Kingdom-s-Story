Shader "Unreal/M_Brick_Small_Alt_06"
{
    Properties
    {
		...
		Material_Texture2D_0( "Brick_Small_Normals_06", 2D ) = "white" {}
		Material_Texture2D_1( "Brick_Small_Alt_06", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "M_Brick_Small_Alt_06.hlsl"
