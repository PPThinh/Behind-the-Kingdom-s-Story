Shader "Unreal/M_Brick_Small_04"
{
    Properties
    {
		...
		Material_Texture2D_0( "Brick_Small_Normals_04", 2D ) = "white" {}
		Material_Texture2D_1( "Brick_Small_04", 2D ) = "white" {}
