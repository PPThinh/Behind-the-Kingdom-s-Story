...
namespace DaimahouGames.Runtime.Characters
{
    public static class CharacterExtensions
    {
        ...
        public static Task PlayGestureState(this Character character, ReactiveState state, Args args)
        {
            ...
            return stateOutput.SetState(state, args);
        }
        ...
        public static void StopFacingLocation(this Character character)
        {
            if (character.Kernel.Facing is UnitFacingPivotLocation facing)
            {
            ...
            {
                character.Kernel.ChangeFacing(character, new UnitFacingPivot());
            }
        }
    }
}