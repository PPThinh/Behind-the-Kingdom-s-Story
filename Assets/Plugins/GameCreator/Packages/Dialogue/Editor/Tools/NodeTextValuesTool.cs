...
{
    public class NodeTextValuesTool : TPolymorphicListTool
    {
        private const string NAME_BUTTON_ADD = "GC-Dialogue-NodeTextValues-Foot-Add";
        ...
        protected override string ElementNameHead => "GC-Dialogue-NodeTextValues-Head";
        protected override string ElementNameBody => "GC-Dialogue-NodeTextValues-Body";
        protected override string ElementNameFoot => "GC-Dialogue-NodeTextValues-Foot";

        protected override List<string> CustomStyleSheetPaths => new List<string>
        {
            EditorPaths.PACKAGES + "Dialogue/Editor/StyleSheets/NodeTextValues"
        };
        ...
        public NodeTextValuesTool(SerializedProperty property) : base(property, "m_Values")
        {
        ...
        {
            return new NodeTextValueTool(this, index);
        }
        ...
        protected override void SetupFoot()
        {
            ...
            this.m_ButtonAdd.clicked += () =>
            {
                ...
                this.PropertyList
                    ...
                    .SetValue(new NodeText.NodeTextValue());
