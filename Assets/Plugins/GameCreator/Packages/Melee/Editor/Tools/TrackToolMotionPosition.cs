...
{
    public class TrackToolMotionPosition : TrackTool
    {
        // CONSTRUCTOR: ---------------------------------------------------------------------------
        
        public TrackToolMotionPosition(SequenceTool sequenceTool, int trackIndex) 
        ...
        {
            clip.SetValue(new ClipMeleeRootMotionPosition());
