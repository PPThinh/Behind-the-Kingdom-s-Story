...
{
    internal class NodeToolStateMachineSubgraph : TNodeToolStateMachine
    {
        ...
        public override string Title
        {
            get
            {
                ...
                return graph != null ? TextUtils.Humanize(graph.name) : TITLE_NONE;
            }
        }
        ...
        public NodeToolStateMachineSubgraph(TGraphTool graphTool, SerializedProperty property)
        ...
        private void EnterGraph()
        {
            ...
            switch (asset)
            {
                ...
                case ActionPlan:
                    WindowActionPlan.Open(this.Graph as ActionPlan);
                    break;
