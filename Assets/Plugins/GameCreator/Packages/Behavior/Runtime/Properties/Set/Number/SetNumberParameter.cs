...
namespace GameCreator.Runtime.Behavior
{
    ...
    [Description("Sets the numeric value of a Processor's Parameter")]

    [Serializable] [HideLabelsInEditor]
    public class SetNumberParameter : PropertyTypeSetNumber
    {
        ...
        public override double Get(Args args)
        {
            ...
            return (double) processor.RuntimeData.GetParameter(this.m_Name.String);
        }
