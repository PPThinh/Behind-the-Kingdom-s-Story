...
{
    public class AttributeItemTool : TPolymorphicItemTool
    {
        ...
        protected override object Value => this.m_Property.GetValue<AttributeItem>();
        
        // CONSTRUCTOR: ---------------------------------------------------------------------------

        public AttributeItemTool(IPolymorphicListTool parentTool, int index)
        ...
        protected override void SetupHeadExtras()
        {
            ...
            headHidden.tooltip = "Hidden Attributes won't be displayed in the Traits component";
