...
namespace GameCreator.Runtime.VisualScripting
{
    ...
    [Serializable]
    public abstract class TInstructionPhysics2DOverlap : Instruction
    {
        protected const int LENGTH = 30;
        private static readonly Collider2D[] COLLIDERS = new Collider2D[LENGTH];
        ...
        protected abstract int GetColliders(Collider2D[] colliders, Args args);
    }
}