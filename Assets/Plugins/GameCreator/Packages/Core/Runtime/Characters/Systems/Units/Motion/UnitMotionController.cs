...
namespace GameCreator.Runtime.Characters
{
    ...
    public class UnitMotionController : TUnitMotion
    {
        ...
        [FormerlySerializedAs("m_Gravity")] [SerializeField] private float m_GravityUpwards = -9.81f;
        [FormerlySerializedAs("m_Gravity")] [SerializeField] private float m_GravityDownwards = -9.81f;
